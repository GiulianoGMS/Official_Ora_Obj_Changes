create or replace view mflv_basedfitem as
select a.rowid id_df, 'D' tipotabela, 'S' tipnotafiscal,
       ...
       nvl(b.vlricms, round((case when b.tipocalcicmsfisci = 25 then -- RP 144194
                   ...
                   when g.uf = 'RJ' and substr(b.situacaonf, -2) = '51' then
                     round((b.bascalcicms * b.peraliquotaicms / 100), 2) - round(nvl(b.vlricmsdiferido, 0), 2)
                 else
       ...
       fObsItemPedVendaLongStr(a.numerodf, a.seriedf, a.nroempresa, b.seqproduto, b.qtdembalagem, a.seqnotafiscal, b.seqitemdf) ObsItemPedVendaLongStr,
       ...
       b.vlricmsdif,
       null basefcpdif,
       null peraliquotafcpdif,
       null vlrfcpdif,
       null vlricmsdifbruto,
       b.indtribsaidadevol,
       ...
       case when c.tipdocfiscal = 'D' then
           ...
           case when b.indcalcicmsdesonoutros = 'S' then
             case when g.uf in ('RJ','GO','SC') then b.INDMOTIVODESOICMS
             else 9
             end
           else
             null
       ...
       b.vlrfcpicmsdiferido,
       b.baseFcpIcmsDiferido,
       decode(c.tipdocfiscal, 'D', b.vlricmsdistrib, b.vlricmsoppropdistrib) vlrIcmsDistriProp,
       A.MEDPACIENTENOME,
       c.indperdamed,
       B.VLRDESCMEDALHA,
       B.VLRIPIPRECOVDA,
       a.indpresenca,
       null as CpfCnpjDevolucao,
       null SeqPessoaTomadorNfse,
       e.percaliqadrem peraliqicmsmonoretanterior,
       case when nvl(e.indprodtributmonoicms, 'N') = 'S' then
         case when b.fatorconvembnfe is not null then
           (b.quantidade / b.qtdembalagem) * b.fatorconvembnfe
         else
           b.quantidade / b.qtdembalagem
         end
       else
         null
       end basicmsmonoretanterior,
       case when nvl(e.indprodtributmonoicms, 'N') = 'S' then
         case when b.fatorconvembnfe is not null then
           ((b.quantidade / b.qtdembalagem) * b.fatorconvembnfe) * e.percaliqadrem
         else
           (b.quantidade / b.qtdembalagem) * e.percaliqadrem
         end
       else
         null
       end vlricmsmonoretanterior,
       e.percindmistbiodiesel,
       a.seqreceitarendto,
       case when nvl(b.indsubtraiicmsdesontotitem, 'S') = 'S' then
         nvl(b.vlrtoticmsdesonoutros,0)
       else
         0
       end vlrtoticmsdesonitemsubtrai,
       -- IBS
       B.VLRBASEIBSMUN,
       B.PERALIQIBSMUN,
       B.VLRIMPOSTOIBSMUN,
       ...
       B.FORMULAIBSMUN,
       B.CENARIOIBSMUN,
       B.PERALIQEFETIVAIBSMUN,
       B.VLRIMPOSTOINTEGRALIBSMUN,
       B.VLRNAODIFERIDOIBSMUN,
       B.PERDIFERIMENTOIBSMUN,
       B.INDREGULARIBSMUN,
       B.INDDIFERIDOIBSMUN,
       B.VLRBASEIBSUF,
       B.PERALIQIBSUF,
       ...
       B.FORMULAIBSUF,
       B.CENARIOIBSUF,
       B.PERALIQEFETIVAIBSUF,
       B.VLRIMPOSTOINTEGRALIBSUF,
       B.VLRBASECCREDPRESIBSUF,
       B.PERALIQCCREDPRESIBSUF,
       B.VLRCCREDPRESIBSUF,
       B.PERALIQREDCCREDPRESIBSUF,
       B.FORMULACCREDPRESIBSUF,
       B.CCREDPRESIBSUF,
       B.VLRNAODIFERIDOIBSUF,
       B.PERDIFERIMENTOIBSUF,
       B.INDREGULARIBSUF,
       B.INDDIFERIDOIBSUF,
       B.CSTIBSMUN,
       B.CCLASSTRIBIBSMUN,
       B.CSTIBSUF,
       CASE WHEN C.TIPDOCFISCAL = 'D' THEN NVL(NAGF_PALIATIVO_CCLASSTRIB_DEV(B.SEQNFREF),B.CCLASSTRIBIBSUF) ELSE B.CCLASSTRIBIBSUF END CCLASSTRIBIBSUF,
       B.CSTREGULARIBSMUN,
       B.CCLASSTRIBREGULARIBSMUN,
       B.PERALIQREGULARIBSMUN,
       B.VLRIMPOSTOREGULARIBSMUN,
       B.VLRDIFERIDOIBSMUN,
       B.PERALIQCCREDPRESIBSMUN,
       B.VLRCCREDPRESIBSMUN,
       B.PERALIQREDCCREDPRESIBSMUN,
       B.VLRBASEREGULARIBSMUN,
       B.CSTREGULARIBSUF,
       B.CCLASSTRIBREGULARIBSUF,
       B.PERALIQREGULARIBSUF,
       B.VLRIMPOSTOREGULARIBSUF,
       B.VLRBASEMONORETIBSUF,
       B.PERALIQMONORETIBSUF,
       B.VLRIMPOSTOMONORETIBSUF,
       B.VLRDIFERIDOIBSUF,
       B.VLRBASEREGULARIBSUF,
       B.INDMONOFASICOIBSUF,
       -- CBS
       B.VLRBASECBS,
       B.PERALIQCBS,
       B.VLRIMPOSTOCBS,
       ...
       B.CENARIOCBS,
       B.CSTCBS,
       CASE WHEN C.TIPDOCFISCAL = 'D' THEN NVL(NAGF_PALIATIVO_CCLASSTRIB_DEV(B.SEQNFREF),B.CCLASSTRIBCBS) ELSE B.CCLASSTRIBCBS END CCLASSTRIBCBS,
       B.PERALIQEFETIVACBS,
       B.VLRIMPOSTOINTEGRALCBS,
       B.VLRNAODIFERIDOCBS,
       B.PERDIFERIMENTOCBS,
       B.VLRBASECCREDPRESCBS,
       B.PERALIQCCREDPRESCBS,
       B.VLRCCREDPRESCBS,
       B.PERALIQREDCCREDPRESCBS,
       B.FORMULACCREDPRESCBS,
       B.CCREDPRESCBS,
       B.INDREGULARCBS,
       B.INDDIFERIDOCBS,
       B.CSTREGULARCBS,
       B.CCLASSTRIBREGULARCBS,
       B.PERALIQREGULARCBS,
       B.VLRIMPOSTOREGULARCBS,
       B.VLRBASEMONORETCBS,
       B.PERALIQMONORETCBS,
       B.VLRIMPOSTOMONORETCBS,
       B.VLRDIFERIDOCBS,
       B.VLRBASEREGULARCBS,
       B.INDMONOFASICOCBS,
       -- IS
       ...
       null seqnfrefprod,
       null vlricmsstdeson,
       null motivodesonicmsst,
       b.nroreceituario as nroreceituario,
       b.cpfresptecnico as cpfresptecnico,
       b.tipoguiatransito as tipoguiatransito,
       b.nroguia as nroguia,
       b.ufguia as ufguia,
       b.serieguia as serieguia,
       b.tipoguiaagro as tipoguiaagro,
       b.indutilizaguiaagro as indutilizaguiaagro,
       nvl(a.indDoctoSemPagamento,'S') as indDoctoSemPagamento
...
select a.rowid id_df, 'N' tipotabela, a.tipnotafiscal tipnotafiscal,
    ...
    -- nvl(B.SITUACAONFIPI,DECODE(A.Tipnotafiscal, 'E', '00',decode(c.tipdocfiscal, 'D', '50', '99'))) SITUACAONFIPI,
       ...
       nvl(b.vlrpiscofinsverbapdv, 0) vlrpiscofinsverbapdv,
       nvl(b.vlrdescfornec, 0) vlrdescfornec,
       h.classeenquadramentoipi classeenquadramentoipi,
       h.codigoenquadramentoipi codigoenquadramentoipi,
       h.codigoseloipi codigoseloipi,
       null qtdseloipi,
       A.MARCAVOLUME,
       A.NUMEROVOLUME,
       b.basecalcicmsstembutprod,
       ...
       B.INDGERADEBCREDPIS,
       B.INDGERADEBCREDCOFINS,
       Nvl(B.INDSUBICMSDESTOTNF, A.INDSUBICMSDESTOTNF) As INDSUBICMSDESTOTNF,
       NVL(C.INDVENDAINTERPRESENCIAL,'N') INDVENDAINTERPRESENCIAL,
       C.CFOPESTADO,
       b.nfreferencianro nfreferencianro_item, b.nfreferenciaserie nfreferenciaserie_item,
       ...
       NVL(Nvl(b.indsubicmsdestotnf, a.indsubicmsdestotnf), 'S') as indsubtraiicmsdesontotitem,
       b.indcalcoutorgado,
       null tiptributacao,
       nvl(b.indvdaproximovencto, 'N') indvdaproximovencto,
       ...
       null as Datarna,
       b.vlrfcpicmsdiferido,
       NULL baseFcpIcmsDiferido,
       decode(c.tipdocfiscal, 'D', b.vlricmsdistrib, b.vlricmsoppropdistrib) vlrIcmsDistriProp,
       NULL AS MEDPACIENTENOME,
       c.indperdamed,
       B.VLRDESCMEDALHA,
       B.VLRIPIPRECOVDA,
       null as indpresenca,
       a.CpfCnpjDevolucao,
       a.SeqPessoaTomadorNfse,
       g.percaliqadrem peraliqicmsmonoretanterior,
       case
         when nvl(g.indprodtributmonoicms, 'N') = 'S' then
            case when b.fatorconvembnfe is not null then
              (b.quantidade / b.qtdembalagem) * b.fatorconvembnfe
            else
              b.quantidade / b.qtdembalagem
       ...
       case when nvl(g.indprodtributmonoicms, 'N') = 'S' then
             case when b.fatorconvembnfe is not null then
              ((b.quantidade / b.qtdembalagem) * b.fatorconvembnfe) * g.percaliqadrem
            else
              (b.quantidade / b.qtdembalagem) * g.percaliqadrem
            end
       else
         null
       end vlricmsmonoretanterior,
       g.percindmistbiodiesel,
       a.seqreceitarendto,
       case when (a.tipnotafiscal = 'S' or c.tipuso = 'E') and nvl(b.indsubicmsdestotnf, 'S') = 'S' then
         nvl(b.vlrtoticmsdesonerado,0)
       else
         0
       end vlrtoticmsdesonitemsubtrai,
       ...
       B.CCLASSTRIBIBSMUN,
       B.CSTIBSUF,
       CASE WHEN A.TIPNOTAFISCAL = 'S' AND C.TIPDOCFISCAL = 'D' THEN NVL(NAGF_PALIATIVO_CCLASSTRIB_DEV(B.SEQNFREF),B.CCLASSTRIBIBSUF) ELSE B.CCLASSTRIBIBSUF END CCLASSTRIBIBSUF,
       B.CSTREGULARIBSMUN,
       B.CCLASSTRIBREGULARIBSMUN,
       B.PERALIQREGULARIBSMUN,
       B.VLRIMPOSTOREGULARIBSMUN,
       ...
       B.CENARIOCBS,
       B.CSTCBS,
       CASE WHEN A.TIPNOTAFISCAL = 'S' AND C.TIPDOCFISCAL = 'D' THEN NVL(NAGF_PALIATIVO_CCLASSTRIB_DEV(B.SEQNFREF),B.CCLASSTRIBCBS) ELSE B.CCLASSTRIBCBS END CCLASSTRIBCBS,
       B.PERALIQEFETIVACBS,
       B.VLRIMPOSTOINTEGRALCBS,
       B.VLRNAODIFERIDOCBS,
       B.PERDIFERIMENTOCBS,
       ...
       B.PERALIQEFETIVAIS,
       B.VLRIMPOSTOINTEGRALIS,
       null vlricmscalctransf,
       a.indcrt,
       b.indbasemed,
       a.seqnfref seqnfreftopo,
       b.seqnfref seqnfrefprod,
       b.vlricmsstdeson vlricmsstdeson,
       b.motivodesonicmsst motivodesonicmsst,
       null as nroreceituario,
       null as cpfresptecnico,
       null as tipoguiatransito,
       null as nroguia,
       null as ufguia,
       null as serieguia,
       null as tipoguiaagro,
       null as indutilizaguiaagro,
       nvl(a.indDoctoSemPagamento,'S') as indDoctoSemPagamento
